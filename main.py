    ...
    for pos_item in range(len(lista_items)):
        ...
        for pos_of in range(len(lista_ofs)):
            ...
            if ofs[id_of].duracao==0:
                ...
                print('A verificar se é possível produzir ' + str(ovs[id_ov].cod_ov) + ' na semana anterior ' + str(semana_pretendida+semana_inicio_plano))
                ...
                print('A verificar se é possível produzir ' + str(ovs[id_ov].cod_ov) + ' na semana seguinte ' + str(semana_pretendida+1+semana_inicio_plano))
...
print('número de ovs planeadas: ' + str(n_ovs_possiveis))
print('--------------------------------------------------')
